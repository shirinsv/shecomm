...
SECRET_KEY = 'django-insecure-v-bj#nh)g!02@%d49_kljlo7ayi(j0f-c2qv!!_syud%zpl$4('
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR,'shop_templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'shopp_app.context_processors.menu_links',
